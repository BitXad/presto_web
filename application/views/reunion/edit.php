			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="reunion_fecha" value="<?php echo ($this->input->post('reunion_fecha') ? $this->input->post('reunion_fecha') : $reunion['reunion_fecha']); ?>" class="has-datepicker form-control" id="reunion_fecha" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="reunion_hora" class="control-label">Reunion Hora</label>
						<div class="form-group">
							<input type="text" name="reunion_hora" value="<?php echo ($this->input->post('reunion_hora') ? $this->input->post('reunion_hora') : $reunion['reunion_hora']); ?>" class="form-control" id="reunion_hora" />
						</div>
					</div>
				</div>
			</div>
