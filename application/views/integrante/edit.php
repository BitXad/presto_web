    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Integrante Edit</h3>
            </div>
			<?php echo form_open('integrante/edit/'.$integrante['integrante_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="cliente_id" class="form-control">
								...
								{
									$selected = ($cliente['cliente_id'] == $integrante['cliente_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="tipointeg_id" class="form-control">
								...
								{
									$selected = ($tipo_integrante['tipointeg_id'] == $integrante['tipointeg_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="garantia_id" class="form-control">
								...
								{
									$selected = ($garantia['garantia_id'] == $integrante['garantia_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="grupo_id" class="form-control">
								...
								{
									$selected = ($grupo['grupo_id'] == $integrante['grupo_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="integrante_fechareg" value="<?php echo ($this->input->post('integrante_fechareg') ? $this->input->post('integrante_fechareg') : $integrante['integrante_fechareg']); ?>" class="has-datepicker form-control" id="integrante_fechareg" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="integrante_horareg" class="control-label">Integrante Horareg</label>
						<div class="form-group">
							<input type="text" name="integrante_horareg" value="<?php echo ($this->input->post('integrante_horareg') ? $this->input->post('integrante_horareg') : $integrante['integrante_horareg']); ?>" class="form-control" id="integrante_horareg" />
						</div>
					</div>
				</div>
			</div>
