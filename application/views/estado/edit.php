				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="estado_descripcion" value="<?php echo ($this->input->post('estado_descripcion') ? $this->input->post('estado_descripcion') : $estado['estado_descripcion']); ?>" class="form-control" id="estado_descripcion" onKeyUp="this.value = this.value.toUpperCase();" required />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="estado_tipo" value="<?php echo ($this->input->post('estado_tipo') ? $this->input->post('estado_tipo') : $estado['estado_tipo']); ?>" class="form-control" id="estado_tipo" required />
