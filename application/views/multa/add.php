          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="multa_hora" value="<?php echo $this->input->post('multa_hora'); ?>" class="form-control" id="multa_hora" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="multa_detalle" class="control-label">Multa Detalle</label>
						<div class="form-group">
							<input type="text" name="multa_detalle" value="<?php echo $this->input->post('multa_detalle'); ?>" class="form-control" id="multa_detalle" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="multa_numrec" class="control-label">Multa Numrec</label>
						<div class="form-group">
							<input type="text" name="multa_numrec" value="<?php echo $this->input->post('multa_numrec'); ?>" class="form-control" id="multa_numrec" />
						</div>
					</div>
				</div>
			</div>
