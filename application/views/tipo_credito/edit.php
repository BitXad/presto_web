				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tipocredito_nombre" value="<?php echo ($this->input->post('tipocredito_nombre') ? $this->input->post('tipocredito_nombre') : $tipo_credito['tipocredito_nombre']); ?>" class="form-control" id="tipocredito_nombre" required />
						</div>
					</div>
				</div>
			</div>
