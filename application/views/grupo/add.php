...
<!--					<div class="col-md-6">
					...
					<div class="col-md-4">
						<label for="grupo_multafalta" class="control-label">Multa/Falta</label>
						<div class="form-group">
					...
					<div class="col-md-4">
						<label for="grupo_multaretraso" class="control-label">Multa/Retraso</label>
						<div class="form-group">
					...
					<div class="col-md-4">
						<label for="grupo_cuotas" class="control-label">Monto Cuotas</label>
						<div class="form-group">
							<input type="text" name="grupo_cuotas" value="<?php echo $this->input->post('grupo_cuotas'); ?>" class="form-control" id="grupo_cuotas" />
						</div>
					</div>
					<div class="col-md-4">
						<label for="grupo_ahorro" class="control-label">Monto ahorro</label>
						<div class="form-group">
