    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Grupo Add</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="grupo_fecha" value="<?php echo $this->input->post('grupo_fecha'); ?>" class="has-datepicker form-control" id="grupo_fecha" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="grupo_hora" class="control-label">Grupo Hora</label>
						<div class="form-group">
							<input type="text" name="grupo_hora" value="<?php echo $this->input->post('grupo_hora'); ?>" class="form-control" id="grupo_hora" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="grupo_nombre" class="control-label">Grupo Nombre</label>
						<div class="form-group">
							<input type="text" name="grupo_nombre" value="<?php echo $this->input->post('grupo_nombre'); ?>" class="form-control" id="grupo_nombre" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="grupo_codigo" class="control-label">Grupo Codigo</label>
						<div class="form-group">
							<input type="text" name="grupo_codigo" value="<?php echo $this->input->post('grupo_codigo'); ?>" class="form-control" id="grupo_codigo" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="grupo_iniciosolicitud" class="control-label">Grupo Iniciosolicitud</label>
						<div class="form-group">
							<input type="text" name="grupo_iniciosolicitud" value="<?php echo $this->input->post('grupo_iniciosolicitud'); ?>" class="has-datepicker form-control" id="grupo_iniciosolicitud" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="grupo_monto" class="control-label">Grupo Monto</label>
						<div class="form-group">
							<input type="text" name="grupo_monto" value="<?php echo $this->input->post('grupo_monto'); ?>" class="form-control" id="grupo_monto" />
						</div>
					</div>
					<div class="col-md-6">
