            ...
            <div class="box-body">
                <div class="row clearfix">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="number" min="0" name="grupo_tiempotolerancia" value="<?php echo ($this->input->post('grupo_tiempotolerancia') ? $this->input->post('grupo_tiempotolerancia') : $grupo['grupo_tiempotolerancia']); ?>" class="form-control" id="grupo_tiempotolerancia" required/>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="form-group" style=" display: flex" >
                            ...
                            <input style="width: 70%; display: inherit; " type="text" name="grupo_multaretrasodetalle" value="<?php echo ($this->input->post('grupo_multaretrasodetalle') ? $this->input->post('grupo_multaretrasodetalle') : $grupo['grupo_multaretrasodetalle']); ?>" class="form-control" id="grupo_multaretrasodetalle" onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" />
                        </div>
                    </div>
                    <div class="col-md-3">
