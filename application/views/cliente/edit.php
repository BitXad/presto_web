<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('cliente/edit/'.$cliente['cliente_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="cliente_extencionci" value="<?php echo ($this->input->post('cliente_extencionci') ? $this->input->post('cliente_extencionci') : $cliente['cliente_extencionci']); ?>" class="form-control" id="cliente_extencionci" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cliente_nombre" class="control-label">Cliente Nombre</label>
						<div class="form-group">
							<input type="text" name="cliente_nombre" value="<?php echo ($this->input->post('cliente_nombre') ? $this->input->post('cliente_nombre') : $cliente['cliente_nombre']); ?>" class="form-control" id="cliente_nombre" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cliente_apellido" class="control-label">Cliente Apellido</label>
						<div class="form-group">
							<input type="text" name="cliente_apellido" value="<?php echo ($this->input->post('cliente_apellido') ? $this->input->post('cliente_apellido') : $cliente['cliente_apellido']); ?>" class="form-control" id="cliente_apellido" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="cliente_latitud" value="<?php echo ($this->input->post('cliente_latitud') ? $this->input->post('cliente_latitud') : $cliente['cliente_latitud']); ?>" class="form-control" id="cliente_latitud" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cliente_longitud" class="control-label">Cliente Longitud</label>
						<div class="form-group">
							<input type="text" name="cliente_longitud" value="<?php echo ($this->input->post('cliente_longitud') ? $this->input->post('cliente_longitud') : $cliente['cliente_longitud']); ?>" class="form-control" id="cliente_longitud" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cliente_referencia" class="control-label">Cliente Referencia</label>
						<div class="form-group">
							<input type="text" name="cliente_referencia" value="<?php echo ($this->input->post('cliente_referencia') ? $this->input->post('cliente_referencia') : $cliente['cliente_referencia']); ?>" class="form-control" id="cliente_referencia" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cliente_foto" class="control-label">Cliente Foto</label>
						<div class="form-group">
							<input type="text" name="cliente_foto" value="<?php echo ($this->input->post('cliente_foto') ? $this->input->post('cliente_foto') : $cliente['cliente_foto']); ?>" class="form-control" id="cliente_foto" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cliente_email" class="control-label">Cliente Email</label>
						<div class="form-group">
							<input type="text" name="cliente_email" value="<?php echo ($this->input->post('cliente_email') ? $this->input->post('cliente_email') : $cliente['cliente_email']); ?>" class="form-control" id="cliente_email" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="cliente_fechanac" class="control-label">Cliente Fechanac</label>
						<div class="form-group">
							<input type="text" name="cliente_fechanac" value="<?php echo ($this->input->post('cliente_fechanac') ? $this->input->post('cliente_fechanac') : $cliente['cliente_fechanac']); ?>" class="has-datepicker form-control" id="cliente_fechanac" />
						</div>
					</div>
					<div class="col-md-6">
